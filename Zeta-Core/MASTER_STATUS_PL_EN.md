...
- **Business email:** contact@zeta-core-dsp.com
- **Business domain:** zeta-core-dsp.com (Namecheap, Private Email)
...
1. Project Settings → Domains → **Connect Domain** → enter `zeta-core-dsp.com`.
2. Follow the automatic DNS setup (Namecheap allows this without leaving the flow).
3. Once verified, `/zeta` becomes reachable at `https://zeta-core-dsp.com/zeta`.

**Email check:** https://privateemail.com (login: `contact@zeta-core-dsp.com`) or the "Private Email" mobile app.

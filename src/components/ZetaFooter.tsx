  ...
  return (
    <footer className="mt-12 border-t border-border/40 pt-6 pb-4 text-xs text-muted-foreground">
      <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <div className="font-semibold text-foreground">NovaStream88 Ltd</div>
          <div>{lang === "pl" ? "Zarejestrowana w Londynie · Operacyjnie: Aberdeen, Szkocja" : "Registered in London · Operations: Aberdeen, Scotland"} · <a href="mailto:contact@zeta-core-dsp.com" className="underline hover:text-foreground">contact@zeta-core-dsp.com</a></div>
          <div>© {new Date().getFullYear()} NovaStream88 Ltd. {t.rights}.</div>
        </div>

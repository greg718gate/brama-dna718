...
const translations = {
  pl: {
    ...
    'exit.preset1Name': '🌀 Aktywacja indywidualna',
    ...
    'exit.preset3Name': '💫 Materializacja świadomości',
    'exit.preset3Desc': 'Dostęp do wiecznych cykli wzrostu',
    'exit.preset4Name': '✨ Pełne przejście',
    'exit.preset4Desc': 'Pełne wyrażenie Źródła w materii',
  ...
  en: {
    ...
    'exit.preset1Name': '🌀 Individual Activation',
    ...
    'exit.preset3Name': '💫 Consciousness Materialization',
    'exit.preset3Desc': 'Access to eternal cycles of growth',
    'exit.preset4Name': '✨ Full Transition',
    'exit.preset4Desc': 'Full expression of Source in matter',

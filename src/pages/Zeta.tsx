...
const T = {
  pl: {
    ...
    aboutP2: "Obliczenia działają lokalnie w piaskownicy przeglądarki i Web Workerze — bez instalatorów oraz zewnętrznych plików wykonywalnych. Kod jest otwarty: github.com/greg718gate/brama-dna718.",
    ...
    tech: [
      ...
      { name: "Bezpieczeństwo i transparentność", desc: "Lokalna analiza w pamięci przeglądarki, osobny Web Worker i publiczny kod Open Source. Status: test_phase — bez opłat." },
    ],
    ...
    pricingTitle: "Cennik",
    pricingSub: "test_phase / faza testowa — dostęp otwarty, bez opłat.",
    pricing: [
      { name: "Portal przeglądarkowy", price: "test_phase", period: "bez opłat", desc: "Lokalne obliczenia i wizualizacje w bezpiecznej piaskownicy przeglądarki.", cta: "Otwórz portal", featured: true },
    ],
    ...
    contactLead: "Pytania o otwartą fazę testową i publiczny kod źródłowy.",
  ...
  en: {
    ...
    aboutP2: "Calculations run locally in the browser sandbox and a Web Worker, with no installers or external executables. The code is open at github.com/greg718gate/brama-dna718.",
    ...
    tech: [
      ...
      { name: "Security and transparency", desc: "Local in-browser processing, a dedicated Web Worker and public Open Source code. Status: test_phase — free access." },
    ],
    ...
    pricingSub: "test_phase — open access, no payment.",
    pricing: [
      { name: "Browser portal", price: "test_phase", period: "free access", desc: "Local calculations and visualisations inside the browser sandbox.", cta: "Open portal", featured: true },
    ],
    ...
    contactLead: "Questions about the open test phase and public source code.",
    contactCompany: "NovaStream88 Ltd",

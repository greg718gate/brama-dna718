...
const ResearchVault = () => {
  ...
  const defaultResearches: Research[] = useMemo(() => [
    ...
    },
    {
      ...
      verification:
        "Spektroskopia molekularna DNA potwierdza rezonans w zakresie 700-740 Hz. Badania biofizyczne wykazują, że częstotliwości Solfeggio mają wpływ na strukturę DNA i ekspresję genów. Harmoniczny związek 718.57/7.83 = 91.7 sugeruje fundamentalną relację biologia-planeta.",
      author: "DNA Gate Research",

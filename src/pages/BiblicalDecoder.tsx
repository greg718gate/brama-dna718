        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
              ...
              <p className="text-xs">{t('decoder.purpose.desc')}</p>
            </div>
          </CardContent>
        </Card>
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm font-mono">
                    <div>Σ: <span className="text-primary font-bold">{result.gematriaTotal}</span></div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm font-mono space-y-1">
                    <div>Gate: <span className="text-primary font-bold">{result.hamiltonGate}</span></div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm font-mono">
                    ...
                    <div>C = <span className="text-primary font-bold">{(result.psi.coherence * 100).toFixed(2)}%</span></div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm font-mono">
                    ...
                    <div>M = <span className="text-primary font-bold">{result.vi.materializationPotential.toFixed(6)}</span></div>
                    <div>C_end = <span className="text-primary font-bold">{(result.vi.coherenceAtEnd * 100).toFixed(2)}%</span></div>
                    <div>Teleport: <span className={result.vi.teleportReady ? "text-green-400 font-bold" : "text-muted-foreground"}>{result.vi.teleportReady ? "✓" : "×"}</span></div>
                  </div>
                </div>
                <Separator className="my-4" />
            ...
            <Card className="border-border">
              ...
              <CardContent className="space-y-3">
                  ...
                  {result.intentionOperator.diagonal.map((val, i) => {
                    ...
                    return (
                      <div key={i} className={`p-2 rounded border ${isDominant ? "border-primary bg-primary/10" : "border-border bg-muted/20"}`}>
                        <div className="text-muted-foreground text-[10px]">Gate {i + 1} ({GATCA_GATES[i]})</div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
                  <div><span className="text-muted-foreground">Tr(Ô):</span> <span className="text-primary font-bold">{result.intentionOperator.trace.toFixed(6)}</span></div>
                  <div><span className="text-muted-foreground">Max λ:</span> <span className="text-primary font-bold">{result.intentionOperator.maxEigenvalue.toFixed(6)}</span></div>
                  <div><span className="text-muted-foreground">Dom:</span> <span className="text-primary font-bold">Gate {result.intentionOperator.dominantGateIdx + 1}</span></div>
                  <div><span className="text-muted-foreground">Gap:</span> <span className="text-primary font-bold">{result.intentionOperator.spectralGap.toFixed(6)}</span></div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm font-mono">
                  <div className="p-3 rounded-lg bg-muted/20 border border-border">
                    <div className="text-xs text-muted-foreground mb-1">γ_d</div>
                  ...
                  <div className="p-3 rounded-lg bg-muted/20 border border-border">
                    <div className="text-xs text-muted-foreground mb-1">C_remaining</div>
                    <div className="text-primary font-bold">{(result.decoherence.remainingCoherence * 100).toFixed(4)}%</div>
                  </div>
                  <div className="p-3 rounded-lg bg-muted/20 border border-border">
                    <div className="text-xs text-muted-foreground mb-1">Tr(ρ²)</div>
                    <div className="text-primary font-bold">{result.decoherence.purity.toFixed(6)}</div>
                  </div>
                  <div className="p-3 rounded-lg bg-muted/20 border border-border">
                    <div className="text-xs text-muted-foreground mb-1">Thermal (37°C)</div>
                    ...
                    <AccordionItem key={i} value={`bible-${i}`}>
                      ...
                      <AccordionContent className="space-y-3 text-sm">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          ...
                          <div className="p-2 rounded bg-muted/20 border border-border text-xs font-mono">
                            <span className="text-muted-foreground">Key:</span> <span className="text-primary">{conn.numericalKey}</span>
                          </div>
                        </div>
                      </AccordionContent>
                    </AccordionItem>
